...
import { SingleAppPackagePickerComponent } from "./single-app-package-picker.component";

@Component({
    template: `
        <bl-single-app-package-picker [(ngModel)]="appPackages" (hasLinkedStorage)="handleHasLinkedStorage($event)">
        </bl-single-app-package-picker>
    `,
})
class TestComponent {
...
describe("SingleAppPackagePickerComponent", () => {
    let fixture: ComponentFixture<TestComponent>;
    let testComponent: TestComponent;
    let component: SingleAppPackagePickerComponent;
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            ...
            declarations: [SingleAppPackagePickerComponent, TestComponent],
            providers: [
