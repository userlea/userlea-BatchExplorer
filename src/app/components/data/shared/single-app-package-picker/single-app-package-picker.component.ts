...
import "./single-app-package-picker.scss";
...
@Component({
    selector: "bl-single-app-package-picker",
    templateUrl: "single-app-package-picker.html",
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => SingleAppPackagePickerComponent), multi: true },
        { provide: NG_VALIDATORS, useExisting: forwardRef(() => SingleAppPackagePickerComponent), multi: true },
    ],
})
export class SingleAppPackagePickerComponent implements ControlValueAccessor, Validator, OnDestroy {
    ...
    constructor(
        ...
        this._subscriptions.push(this.items.valueChanges.subscribe((references: PackageReference[]) => {
            ...
            console.log("Last app package", last);
            ...
            if (this._propagateChange) {
                ...
                console.log("Cloned app package", cloned);
